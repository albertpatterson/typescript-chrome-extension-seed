module.exports = function (prefix, task_factory) {
  ...
  task_factory.sass(prefix, 'src/injected/styles/**/*.scss', buildDir, "injected-styles.css");
  task_factory.ts(prefix, "./", ["src/injected/main/main.ts"], buildDir, "injected-bundle.js");
